...
| T24 | Livrer le centre de notifications persistant | Les événements de publication, modération et clôture créent des notifications ciblées ; l’aperçu d’en-tête et la page de notifications affichent les états réels lu/non lu, les filtres, l’action explicite « tout marquer comme lu », des liens d’alerte protégés et l’état simulé de l’e-mail. Un instantané de polling privé et non mis en cache rafraîchit les compteurs de notifications et de travail toutes les 30 secondes ; Home et Alerts signalent les nouvelles alertes éligibles sans déplacer la lecture. | T17, T18, T23 | Terminé |
